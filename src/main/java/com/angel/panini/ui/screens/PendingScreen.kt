...
fun PendingScreen(
    ...
    val stickers by viewModel.pendingStickers.collectAsState()
        ...
        if (filteredStickers.isEmpty()) {
            Box(
                ...
                Column(
                    ...
                    Spacer(modifier = Modifier.height(16.dp))
                    Text(
                        text = "No se encontraron láminas",
                        style = MaterialTheme.typography.titleMedium,
...
@Composable
fun PendingStickerItem(sticker: StickerEntity, onClick: () -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
